...
const Parts = ({part}) => {
    const {name, description,img, price, availableQuantity, minOrderQuantity } = part;
    ...
    return (
        ...
        <div class="card-body items-center text-center">
          ...
          <div class="card-actions">
            <button class="btn btn-primary mt-3" onClick={ ()=> navigate("/purchase")}>Purchase Now</button>
          </div>
        </div>
      </div>
    );
